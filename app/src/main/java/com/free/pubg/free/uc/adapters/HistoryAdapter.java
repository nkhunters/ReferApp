...
import com.free.pubg.free.uc.activities.ParticipateHistory;
...
public class HistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HistoryAdapter(Context context, List<Object> recyclerViewItems) {
    ...
    public int getItemViewType(int position) {
        return (position % ParticipateHistory.ITEMS_PER_AD == 0) ? BANNER_AD_VIEW_TYPE
                : MENU_ITEM_VIEW_TYPE;
    }
        ...
        switch (viewType) {
            case MENU_ITEM_VIEW_TYPE:
                View menuItemLayoutView = LayoutInflater.from(viewGroup.getContext()).inflate(
                        R.layout.royal_pass_history_item, viewGroup, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            case MENU_ITEM_VIEW_TYPE:
                ...
                Winner menuItem = (Winner) recyclerViewItems.get(position);
